...
describe('placeholders', () => {
  ...
  describe('without an existing DOM element', () => {
    ...
    it('should not render with dynamic attributes', () => {
      expect(el.getAttribute('data-foo')).not.to.equal('bar');
    });
  });
  ...
  describe('with an existing DOM element', () => {
    ...
    it('should not set dynamic attributes', () => {
      expect(div.getAttribute('data-foo')).not.to.equal('bar');
    });
